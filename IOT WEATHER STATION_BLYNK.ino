...
#include <Adafruit_BMP280.h>          //Including the library for BMP180

Adafruit_BMP280 bmp;                  //Defining the object bmp
...
char ssid[] = ""; //SSID of the WiFi hotspot available
...
//______________________Reading the value of Pressure, Temperature, Altitude from the BMP180__________________
 ...
 //___________________LDA SENSOR CODE_____________________________(EXTRA)
 ...
 int LDR = analogRead(sensor);
  ...
  Blynk.virtualWrite(V7, LDR); // Give whatever pin is free in node mcu, make sure v7 is not overlapped
